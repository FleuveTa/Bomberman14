...
import com.example.bomberm4n.Graphics.SpriteSheet;
...
public class Sprite {
    ...
    public static Sprite Animation(Sprite normal, Sprite x1, Sprite x2, int animate, int time) {
    ...
    public static Sprite Animation(Sprite x1, Sprite x2, int animate, int time) {
        int diff = time / 2;
