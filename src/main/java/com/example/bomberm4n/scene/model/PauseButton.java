...
public class PauseButton extends Button {
    ...
    static {
        try {
            freeUrl = gameButton.class.getResource("/assets/mobs/button/FreePauseButton.png").toURI().toString();
    ...
    static {
        try {
            clickUrl = gameButton.class.getResource("/assets/mobs/button/ClickPauseButton.png").toURI().toString();
        } catch (URISyntaxException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    static {
        try {
           enterUrl = gameButton.class.getResource("/assets/mobs/button/EnterPauseButton.png").toURI().toString();
        } catch (URISyntaxException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void initialCloseButton() {
